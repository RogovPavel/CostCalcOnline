...
class PositionsController extends Controller {
    ...
    public function accessRules() {
        return array(
            array('allow', 'actions'=>array('index'), 'roles'=>array('view_positions'),),
            array('allow', 'actions'=>array('create'), 'roles'=>array('create_positions'),),
            array('allow', 'actions'=>array('update'), 'roles'=>array('update_positions'),),
            array('allow', 'actions'=>array('delete'), 'roles'=>array('delete_positions'),),
            array('deny',
                    'users'=>array('*'),
            ),
        );
    ...
    public function actionCreate() {
        ...
        try {
            ...
            if (isset($_POST['positions'])) {
                if ($model->validate()) {
                    $model->setAttributes($_POST['positions']);
